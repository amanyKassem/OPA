...
function AdverInfo({navigation}) {
    ...
    const [facebook, setFacebook] = useState(userData ? userData.facebook : '');
    const [twitter, setTwitter] = useState(userData ? userData.twitter : '');
    const [phone, setPhone] = useState(userData ? userData.contact_phone : '');
    const [email, setEmail] = useState(userData ? userData.contact_email : '');
    const [details, setDetails] = useState(userData ? userData.detailes : '');
