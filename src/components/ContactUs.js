            ...
            <Content contentContainerStyle={[styles.bgFullWidth , styles.bg_gray]}>
                ...
                <View style={[styles.bgFullWidth,styles.paddingHorizontal_20 ,styles.bg_White,
                    ...
                    <View style={[styles.rowGroup , styles.Width_100]}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('adFee')} style={[styles.directionRowCenter,styles.Width_48 , styles.marginBottom_15 , styles.Radius_15, styles.height_90,{backgroundColor:'#fde7dd'}]}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('faq')} style={[styles.directionRowCenter,styles.Width_48 , styles.marginBottom_15 , styles.Radius_15, styles.height_90,{backgroundColor:'#c6edf6'}]}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('userManual')} style={[styles.directionRowCenter,styles.Width_48 , styles.marginBottom_15 , styles.Radius_15, styles.height_90,{backgroundColor:'#d4d6f6'}]}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('socialMedia')} style={[styles.directionRowCenter,styles.Width_48 , styles.marginBottom_15 , styles.Radius_15, styles.height_90,{backgroundColor:'#f0c5cc'}]}>
