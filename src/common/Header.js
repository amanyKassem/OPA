            ...
            <View style={[styles.directionRow]}>
                {
                    title === i18n.t('home') || title === i18n.t('profile') || title === i18n.t('add') || title === i18n.t('searchByList') || title === i18n.t('conversations') || title === i18n.t('contracting') ?
                        ...
                        :
                        <TouchableOpacity onPress={() => title === i18n.t('postAdConfirmation') ? navigation.navigate('myAds') : navigation.goBack()} style={{marginRight:15}}>
...

            {
                title === i18n.t('home') || title === i18n.t('profile')  || title === i18n.t('add') || title === i18n.t('searchByList') || title === i18n.t('conversations') || title === i18n.t('contracting') ?
                    ...
                    title === i18n.t('addOrder') ?
                        <View style={[styles.directionRow]}>
                            <TouchableOpacity onPress={() => navigation.navigate('orders')} style={{marginRight:10}}>
